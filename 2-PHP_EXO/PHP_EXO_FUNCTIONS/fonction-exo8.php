...
//Declaration
function nombre_entiers($a , $b) : string
{
    //Instructions
...
nombre_entiers("foo",7)."\n";

$resultat = nombre_entiers("foo",7);

var_dump($resultat);


nombre_entiers(7, "bar")."\n";

$resultat = nombre_entiers(7,"bar");

var_dump($resultat);


nombre_entiers("foo", "bar")."\n";
