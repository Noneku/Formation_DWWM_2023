...
//Display all elements (Personnages)
    for (let i = 0; i < characters.length; i++) {
        ...
        <div class="card" style="width: 18rem;">
            ...
            <a href="biographie.html?nameCharacter=${characters[i].name}&imgCharacter=${characters[i].imageLink}&bioCharacter=${characters[i].bio}" class="btn btn-primary">Consulter Biographie</a>
            </div>
        </div>`;
