...
créer une variable nommée `$url` et lui affecter la valeur `'https://php.net/manual/fr/function.parse-url.php'`
...
$url = 'https://php.net/manual/fr/function.parse-url.php';
