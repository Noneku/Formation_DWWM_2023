...
// Appel la fonction dans les paramètres 10 et 5
$resultat = nombres_entiers(10, 5);
var_dump($resultat);

// Appel de la fonction avec les paramètres 2 et 8
$resultat = nombres_entiers(2, 8);
var_dump($resultat);

// Appel de la fonction avec les paramètres 7 et 7
$resultat = nombres_entiers(7, 7);
var_dump($resultat);

// Appel de la fonction avec les paramètres 'foo' et 5
$resultat = nombres_entiers('foo', 5);
var_dump($resultat);

// Appel de la fonction avec les paramètres 10 et 'bar'
$resultat = nombres_entiers(10, 'bar');
var_dump($resultat);

// Appel de la fonction avec les paramètres 'foo' et 'bar'
