...
// Boucle pour parcourir chaque élément et stocké les artiste dans la variable compositeur est leur période dans la variable période
foreach ($compositeursItaliens as $compositeur => $periode) {
    echo $compositeur . PHP_EOL;
