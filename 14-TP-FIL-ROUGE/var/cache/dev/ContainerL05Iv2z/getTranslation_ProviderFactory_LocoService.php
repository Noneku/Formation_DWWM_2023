...
class getTranslation_ProviderFactory_LocoService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return new \Symfony\Component\Translation\Bridge\Loco\LocoProviderFactory(($container->privates['.debug.http_client'] ?? self::get_Debug_HttpClientService($container)), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), 'fr', ($container->privates['translation.loader.xliff'] ??= new \Symfony\Component\Translation\Loader\XliffFileLoader()), ($container->services['translator'] ?? self::getTranslatorService($container)));
    }
}
