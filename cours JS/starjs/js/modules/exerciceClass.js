...
la classe Personne dispose d'un display qui décrit le nom et le prenom en héritant, 
les 2 classes filles affichent leur propre display : 
( Etudiant - Paul LeBouillon - moyenne : 12.5) (Prof - Robert LaLouche - matières : Français, Espagnol, SVT)
...
5/ Jetez un oeil à Math.random() , attribuez les notes de façon aléatoire sur 20, 
chaque matière de chaque élèves disposera d'une note aléatoire
 */
...
let prof1 = new Professeur("Landier", "Hubert", ["Litérature", "SVT"]);
...
matieres.map(matiere => {
    console.log(`Matiere : ${matiere} moyenne générale : ${moyenneMatiere(eleves,matiere)}`)
})
...
// let etudiant3 = new Etudiant("Lagarde", "kevin", "Générale",
// {
//     Français: getNote(),
//     anglais: getNote(),
//     math: getNote(),
