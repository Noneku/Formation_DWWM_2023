...
class __TwigTemplate_3b71c62b1d3295e36b04b560e5fa041c extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo "
    <button class=\"btn btn-success\" id=\"btn-enregistrement\">";
        // line 3
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-success\" id=\"btn-enregistrement\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "user/_form.html.twig", "C:\\xampp_2\\htdocs\\TP_DWM\\TP-FIL-ROUGE\\templates\\user\\_form.html.twig");
    }
}
