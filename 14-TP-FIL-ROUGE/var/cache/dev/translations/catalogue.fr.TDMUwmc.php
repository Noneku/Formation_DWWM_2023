...
$catalogue = new MessageCatalogue('fr', array (
  ...
  'messages' => 
  array (
    'menu.choose_language' => 'Choisissez la langue',
    'menu.english' => 'AN',
    'menu.french' => 'FR',
    'welcome.title1' => 'BIENVENUE À',
    'welcome.title2' => 'VICE CITY',
    'welcome.title3' => 'HÔTEL',
    'welcome.description' => 'Réservez votre séjour et découvrez le luxe redéfini à des tarifs abordables.',
    'navbar.connexion' => 'Se connecter',
    'navbar.contact' => 'Contactez-nous',
    'navbar.hebergement' => 'Hébergement',
    'navbar.chambre1' => 'Chambre Double Deluxe',
    'navbar.chambre2' => 'Chambre Double Supérieure',
    'navbar.chambre3' => 'Suite Junior',
    'navbar.visite' => 'Visiter l\'hôtel',
    'navbar.reservation' => 'Mes réservations',
    'navbar.admin' => 'Bonjour Admin',
    'navbar.user' => 'Bonjour',
    'navbar.profil' => 'Gérer mon profil',
    'navbar.deconnexion' => 'Déconnexion',
    'creation.titre' => 'Création du Vice City Hotel',
    'creation.texte' => 'Un hotel de luxe née de l\'audace et de la vision de ses fondateurs éminents : Akaza, Batman, Elcroco et Karim. Fondé en 2023, cet établissement incarne l\'alliance parfaite entre l\'élégance contemporaine et le glamour intemporel. Les influences uniques de chaque fondateur se reflètent dans chaque recoin, créant une atmosphère distinctive qui redéfinit l\'expérience hôtelière. Que vous soyez attiré par le style avant-gardiste d\'Akaza, la sophistication de Batman, l\'excentricité d\'Elcroco ou la chaleur accueillante de Karim, le Vice City Hotel offre une escapade inoubliable, où le luxe rencontre l\'individualité. Chaque détail, de l\'architecture à la cuisine, est une célébration de l\'innovation et du raffinement, promettant à chaque invité une expérience d\'exception au cœur de la ville. Bienvenue dans le monde exclusif du Vice City Hotel, où le confort, le style et la personnalité se rencontrent pour créer une destination inégalée.',
    'titre.titre1' => 'Découvrez nos chambres',
    'titre.titre2' => 'Notre position',
    'caroussel.titre1' => 'Nos chambres sont conçues pour transporter vous dans un environnement fait pour les loisirs. Ne pensez plus au quotidien à la maison vie et trouvez un paradis privé pour vous-même',
    'caroussel.titre2' => 'Tous nos types de chambres comprennent le petit-déjeuner gratuit.',
    'footer.titre1' => 'Notre hôtel combine élégance intemporelle, commodités modernes et un service exceptionnel pour créer une atmosphère accueillante et apaisante.',
    'footer.copyright' => '© 2023 Vice city Hôtel. Tous droits réservés.',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'welcome.title2' => 'VICE CITY',
    'welcome.title3' => 'HOTEL',
    'welcome.description' => 'Book your stay and experience redefined luxury at the most affordable rates.',
    'navbar.connexion' => 'Log in',
    'navbar.contact' => 'Contact us',
    'navbar.hebergement' => 'Hosting',
    'navbar.chambre1' => 'Room Double Deluxe',
    'navbar.chambre2' => 'Room Double Superior',
    'navbar.chambre3' => 'Suite Junior',
    'navbar.visite' => 'Visit the hotel',
    'navbar.reservation' => 'My bookings',
    'navbar.admin' => 'Hello Admin',
    'navbar.user' => 'Hello',
    'navbar.profil' => 'Manage my profile',
    'navbar.deconnexion' => 'Log out',
    'creation.titre' => 'Creation of Vice City Hotel',
    'creation.texte' => 'A luxury hotel born from the boldness and vision of its eminent founders: Akaza, Batman, Elcroco, and Karim. Founded in 2023, this establishment embodies the perfect blend of contemporary elegance and timeless glamour. The unique influences of each founder are reflected in every corner, creating a distinctive atmosphere that redefines the hotel experience. Whether drawn to Akaza\'s avant-garde style, Batman\'s sophistication, Elcroco\'s eccentricity, or Karim\'s warm hospitality, Vice City Hotel offers an unforgettable escape where luxury meets individuality. Every detail, from architecture to cuisine, is a celebration of innovation and refinement, promising each guest an exceptional experience in the heart of the city. Welcome to the exclusive world of Vice City Hotel, where comfort, style, and personality come together to create an unparalleled destination.',
    'titre.titre1' => 'Discover our rooms',
    'titre.titre2' => 'Our position',
    'caroussel.titre1' => 'Our rooms are designed to transport you to an environment made for leisure. Forget about the everyday home life and find a private paradise for yourself.',
    'caroussel.titre2' => 'All our room types include complimentary breakfast.',
    'footer.titre1' => 'Our hotel combines timeless elegance, modern amenities, and exceptional service to create a welcoming and soothing atmosphere.',
    'footer.copyright' => '© 2023 Vice City Hotel. All rights reserved.',
  ),
));
