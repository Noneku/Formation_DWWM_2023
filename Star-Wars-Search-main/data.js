...
// Quand l'utilisateur tape dans la barre de recherche, filtre la liste des personnages
search.addEventListener("input", () => {
// Récupère la chaîne de caractères saisie par l'utilisateur
const query = search.value;

// Filtre la liste des personnages par la chaîne de caractères saisie
const filteredCharacters = characters.filter(character => character.name.toLowerCase().includes(query.toLowerCase()));

// Affiche les images des personnages filtrés
