        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href = "./ClasseDWWM.php">Plan de classe</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="./InventaireFolderSaveCSV.php">Mes Dossier</a>
                  </li>
                </ul>
          ...
          <!-- <form action="../Ctrl/execute_shuffleArray.php" method="get" class="d-flex justify-content-evenly flex-row mt-3">
            ...
            <table class="table">
              <thead>
                <tr>
                  <th scope="col">Fichier Sauvegarde</th>
                </tr>
              </thead>
              <tbody>
                  <?php
                    foreach ($_SESSION['folder'] as $key => $value) {
                          echo "<tr>";
