...
Il permet de créer une condition séparé// */


/* sans ternaire , avec le if */
let connected = false; 
...
// tips : si l'objet n'existe pas (null)la réponse sera undefined grâce au "?" car display() est une méthode de vehicule et de ses enfants//

console.log(monVehicule?.display());

//destructuring
//récuperer des infos d'un objet ou d'un tableau sous forme de variable//

const {nom, affiliation, infos} = personnages[0];

console.log(nom , affiliation , infos);
...
//     passions : ["tennis" , "surf" , "tuto beauté"]
// }
...
const etudiant1 = new Etudiant("Quentin" , "OLIVIER", "SVT");
etudiant1.ajouterNote("français" , (Math.floor(Math.random()*20) ))
etudiant1.ajouterNote("anglais" , (Math.floor(Math.random()*20) ))
etudiant1.ajouterNote("math" , (Math.floor(Math.random()*20) ))
etudiant1.ajouterNote("SVT" , (Math.floor(Math.random()*20) ))
etudiant1.ajouterNote("espagnol" , (Math.floor(Math.random()*20) ))
etudiant1.display();



const etudiant2 = new Etudiant("Luc" , "Hiluc", "français");
etudiant2.ajouterNote("français" , (Math.floor(Math.random()*20) ))
etudiant2.ajouterNote("anglais" , (Math.floor(Math.random()*20) ))
etudiant2.ajouterNote("math" , (Math.floor(Math.random()*20) ))
etudiant2.ajouterNote("SVT" , (Math.floor(Math.random()*20) ))
etudiant2.ajouterNote("espagnol" , (Math.floor(Math.random()*20) ))
etudiant2.display();
...
// console.log(etudiant1.notes["anglais"]);


const prof1 = new Professeur("Yves" , "Renard" , ["français" , "anglais" , "espagnol"])

prof1.display();

const prof2 = new Professeur("Yves" , "Renard" , ["SVT" , "math" , "français"])
