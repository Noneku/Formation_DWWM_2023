...
*/
function plus_grand($a,$b):string{
...
$resultat=var_dump(plus_grand(10,5));
$resultat=var_dump(plus_grand(2,8));
$resultat=var_dump(plus_grand(7,7));
$resultat=var_dump(plus_grand('foo',5));
$resultat=var_dump(plus_grand(10,'bar'));
$resultat=var_dump(plus_grand('foo','bar'));
