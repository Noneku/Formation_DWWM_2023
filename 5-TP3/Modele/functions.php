...
function saveStudentsToJSONFile(array $assoStudents) {

    $fileName = '../Modele/sauvegardes/save_date'.date("d-m-Y_His"). '.json';
...
// Boucle avec concaténation permettant de reprendre les clés et de les associer individuellement à chaque stagiaire :
    ...
    file_put_contents($fileName, json_encode($assoStudents));
...
//     file_put_contents(json_encode($fileName, $assoStudents));
